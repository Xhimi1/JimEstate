...
export const listings: Listing[] = [
  ...
  },
  {
    ...
    description:
      'A spectacular full-floor penthouse on the 48th floor of one of Midtown Manhattan\'s premier residential towers. This three-bedroom, three-bathroom residence offers 360-degree city views through oversized windows that line every facade. The great room features soaring 11-foot ceilings and opens onto a private wraparound terrace with unobstructed views of Central Park and the Manhattan skyline. The chef\'s kitchen features Miele appliances and custom Italian cabinetry. The primary suite includes a dressing room, spa bath with soaking tub, and direct terrace access. Building amenities include a full-time doorman, concierge, fitness center, and rooftop lounge.',
    featured: false,
  },
  {
    id: '6',
    ...
    description:
      'A distinguished Federal-style brick townhouse on one of Georgetown\'s most scenic cobblestone streets. This four-bedroom, three-and-a-half-bathroom home has been sensitively updated to offer the best of historic character and contemporary comfort. The main level features gracious entertaining rooms with crown moldings, a working fireplace, and wide-plank pine floors. The renovated kitchen opens to a private walled garden — a rare urban oasis. The upper floors house four generous bedrooms, including a luxurious primary suite with a spa bathroom and dressing room. One block from the C&O Canal towpath, steps from boutiques and acclaimed restaurants.',
    featured: false,
  },
]
